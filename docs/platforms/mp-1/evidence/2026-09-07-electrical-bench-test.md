...
| Compass calibration data collection | Both detected compasses complete onboard MagCal data collection | Mag 1 and Mag 2 progress bars full; Mission Planner requested autopilot reboot after acceptance | PASS - reboot pending | External M10 IST8310 remains priority 1; internal Pixhawk IST8310 is priority 2 |
...
- The latest pre-arm state before compass calibration was reduced to three blockers: `Waiting for RC`, `Compass not calibrated`, and `Hardware safety switch`.
...
- During onboard MagCal, both Mag 1 and Mag 2 progress bars reached full completion. Mission Planner then requested `Please reboot autopilot`, indicating the calibration data was accepted and requires a reboot before final pre-arm verification.
